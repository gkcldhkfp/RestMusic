                        ...
                        <%@ taglib prefix="c" uri="jakarta.tags.core" %>
                            ...
                            <body>
                                ...
                                <div class="container-fluid" style="padding: 30px;">
                                    <div class="m-5 ">
                                        <div class="p-3">
                                            ...
                                            <!-- 아티스트 이미지 주소 지정 -->
                                            <c:url var="albumPage" value="/artist/albums?artistId=${artist.artistId}" />
                                                ...
                                                <c:catch var="error">
                                                    <%-- 파일 읽기를 시도하고 에러가 발생할 경우 처리 --%>
                                                        ...
                                                        <% ServletContext context=request.getServletContext(); String
                                                            realPath=context.getRealPath((String)
                                                            pageContext.getAttribute("filePath")); File file=new
                                                            File(realPath); BufferedReader reader=null; try { reader=new
                                                            BufferedReader(new FileReader(file)); String line; while
                                                            ((line=reader.readLine()) !=null) { out.println(line
                                                            + "<br>" ); } } catch (FileNotFoundException e) {
                                                            out.println("파일을 찾을 수 없습니다."); } catch (IOException e) {
                                                            out.println("파일을 읽을 수 없습니다."); } finally { if (reader
                                ...
                                <input type="checkbox" id="selectAllCheckbox">
                                                        ...
                                                        <th style="text-align: center; vertical-align: middle;">내 리스트
                                                        </th>
                                                    </tr>
                                                </thead>
                                    ...
                                    <input type="checkbox" class="songCheckbox" data-songId="${s.songId}">
                                        ...
                                        width: 40px; height: 40px; background-size: cover; background-repeat: no-repeat;"
                                                                    data-songId="${s.songId}" data-id="${s.songId}" class="playButton btn"
                                                                    id="listenBtn"
                                                                   ></button>
                                                            </td>
                                                            <td style="text-align: center; vertical-align: middle;">
