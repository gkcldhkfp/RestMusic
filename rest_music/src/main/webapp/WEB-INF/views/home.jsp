            ...
            <main>
                <div class="slideshow-container mt-5" style="margin-top: 20px;">
                    <div class="mySlides">
                        ...
                        <a href="/Rest/playlists/playlist?plistId=3"> <img src="./data/imagee1.gif"
                                style="width: 100%" />
                        </a>
                    </div>
                    ...
                    <div class="mySlides">
                        <div class="numbertext"></div>
                        <a href="/Rest/playlists/playlist?plistId=4"> <img src="./data/imagee3.gif"
                                style="width: 100%" />
                        </a>
                    </div>
                    ...
                    <div class="mySlides">
                        <div class="numbertext"></div>
                        <a href="/Rest/playlists/playlist?plistId=16"> <img src="./data/imagee2.gif"
                                style="width: 100%" />
                        </a>
                    </div>
                ...
                <div style="text-align: center">
                    <span class="dot" onclick="currentSlide(1)"></span> <span class="dot"
                        onclick="currentSlide(2)"></span> <span class="dot" onclick="currentSlide(3)"></span>
                </div>
